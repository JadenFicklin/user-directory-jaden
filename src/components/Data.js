...
function Data() {
  ...
  const leftAngledBracket = "<";
  const rightAngledBracket = ">";
  const [number, setNumber] = useState(0);

  let currentUser = data[number];
  ...
  return (
    <>
      ...
      <div className="object">
        <p className="id-number">{currentUser.id}/25</p>
        <p className="name">
        ...
        <p className="employer">
          <span className="employer-text">Employer:</span>{" "}
          {currentUser.employer}
        </p>
        <p className="favorite-movies">Favorite Movies:</p>
        <p className="movies-1">1. {currentUser.favoriteMovies[0]}</p>
        <p className="movies-2">2. {currentUser.favoriteMovies[1]}</p>
        <p className="movies-3">3. {currentUser.favoriteMovies[2]}</p>
        <button className="previous" onClick={() => setNumber(number - 1)}>
          {leftAngledBracket} Previous
        </button>

        <button className="new" onClick={() => setDisplay(!display)}>
          New
        </button>
        {display && (
          <div
          ...
          >
            <form>
              ...
              <br></br>
              <br></br>
              <input placeholder="favorite movie 1" />
              <input placeholder="favorite movie 2" />
              <input placeholder="favorite movie 3" />
              <br></br>
              <br></br>
...
// {display && <div style={{ color: "white" }}>test</div>}
